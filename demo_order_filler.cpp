//Jason Sun ps9 demo_order-filler
...
int main(int argc, char** argv) {
    ...
    if (boxInspector.get_bad_part_Q(current_part, CAM2)) {
        ...
        cin>>ans;
        //attempt to pick the defected part first from the box and then discard it to the side.
        //using the robot action server ro acquire and dispose the the defected parts in the box.
...
// ///////////////////////////////////////////////////////////////
    ...
    //and repeat for ALL the missing parts
    ...
    // inspector the box one more time to make sure there is no defected part in it before transfor the box further to the loading dock.
