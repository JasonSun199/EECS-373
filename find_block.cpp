...
void ImageConverter::imageCb(const sensor_msgs::ImageConstPtr& msg){
        ...
        block_pose_.pose.position.y = j_centroid; 
        block_pose_.pose.position.x = i_centroid-327.5; //not true, but legal
        block_pose_.pose.position.y = j_centroid-348; //not true, but legal
        double theta=0;
